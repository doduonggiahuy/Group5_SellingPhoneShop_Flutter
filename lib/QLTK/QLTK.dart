...
class _AccountPageState extends State<AccountPage> {
  String name = 'Phan Ba Hoang';
  String birthdate = '14/05/2002';
  String phoneNumber = '0935591120';
  String email = 'capta1njohn7@gmail.com';
  String password = 'noneedpassword';
                ...
                child: Stack(
                  ...
                  children: [
                    CircleAvatar(
                      radius: 80,
                      backgroundImage:
                          AssetImage('assets/images/hoangavatar.png'),
                    ),
                    isEditing
                        ? TextButton(
                            onPressed: () {
